...
class LSM6DS33(I2C):
    ...
    def __del__(self):
        ...
        try:
            ...
            self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL1_XL, 0x00)
            # Power down gyroscope
            self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL2_G, 0x00)
    ...
    def enableLSM(self, accelerometer = True, gyroscope = True,
        ...
        self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL1_XL, 0x00)
        self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL2_G, 0x00)
        self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL3_C, 0x00)
        ...
        # Disable FIFO
        self._writeRegister(self.LSM6DS33_ADDR, self.LSM_FIFO_CTRL5, 0x00)

        if accelerometer:
            # Accelerometer
            # 1.66 kHz / +/- 4g
            # 01011000b
            self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL1_XL, 0x58)
        ...
        if gyroscope:
            ...
            # 01011000b
            self._writeRegister(self.LSM6DS33_ADDR, self.LSM_CTRL2_G, 0x58)
    ...
    def getAccelerometerRaw(self):
        ...
        # Read sensor data
        return self._getSensorRawLoHi3(self.LSM6DS33_ADDR, self.lsmAccRegisters)
    ...
    def getLSMTemperatureRaw(self):
        ...
        # Read sensor data
        return self._getSensorRawLoHi1(self.LSM6DS33_ADDR, self.lsmAccRegisters)
...
def main():
    ...
    while True:
        # print ls.getAllRaw()
        print "Gyro Temperature:", ls.getLSMTemperatureCelsius()
        print "Gyro:", ls.getGyroscopeRaw()
        print "Accelerometer:", ls.getAccelerometerRaw()
        time.sleep(1)
