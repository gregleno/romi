...
class TestMotors(unittest.TestCase):
    ...
    def test_cap_acceleration(self):
    ...
    def test_cap_acceleration_accelerate_too_fast(self):
        """Test that no cp happens if we accelerate by half the max acceleration."""
        ...
        # Same with negative speed values
        assert Motors.cap_acceleration(
            -speed_cmd,
            -last_speed_cmd) == (-last_speed_cmd - Motors.max_acceleration)

    def test_cap_acceleration_decelerate_too_fast(self):
        """Test that no cp happens if we accelerate by half the max acceleration."""
